...
__webpack_require__("./client/src/legacy/VersionedEditForm/VersionedEditForm.js");
...
var _ResizeAware = __webpack_require__(9);

var _ResizeAware2 = _interopRequireDefault(_ResizeAware);

var _ViewModeActions = __webpack_require__(10);
...
var HistoryViewer = function (_Component) {
  ...
  _createClass(HistoryViewer, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var versions = this.props.actions.versions;
    ...
    value: function getVersions() {
      ...
      return versions && versions.versions && versions.versions.nodes ? versions.versions.nodes : [];
    }
  }, {
    ...
    value: function getContainerClasses() {
      var _props = this.props,
          ...
          isInGridField = _props.isInGridField;

      return (0, _classnames2.default)('history-viewer', 'fill-height', 'panel--scrollable', {
    ...
    value: function renderVersionDetail() {
      ...
      var _props3 = this.props,
          ...
          isPreviewable = _props3.isPreviewable,
          recordId = _props3.recordId,
          recordClass = _props3.recordClass,
          schemaUrl = _props3.schemaUrl,
          VersionDetailComponent = _props3.VersionDetailComponent,
          compare = _props3.compare,
          _props3$compare = _props3.compare,
          _props3$compare$versi = _props3$compare.versionFrom,
          versionFrom = _props3$compare$versi === undefined ? false : _props3$compare$versi,
          _props3$compare$versi2 = _props3$compare.versionTo,
          versionTo = _props3$compare$versi2 === undefined ? false : _props3$compare$versi2,
    ...
    value: function renderComparisonSelectionList() {
      var _props5 = this.props,
          versionFrom = _props5.compare.versionFrom,
          ListComponent = _props5.ListComponent;
    ...
    value: function renderVersionList() {
      var _props6 = this.props,
          isInGridField = _props6.isInGridField,
          ListComponent = _props6.ListComponent,
          CompareWarningComponent = _props6.CompareWarningComponent,
          compare = _props6.compare,
          hasVersionFrom = _props6.compare.versionFrom;
    ...
    value: function render() {
      var _props7 = this.props,
          ...
          currentVersion = _props7.currentVersion;
...
HistoryViewer.propTypes = {
  ...
  versions: _propTypes2.default.shape({
    versions: _propTypes2.default.shape({
      ...
      nodes: _propTypes2.default.arrayOf(_versionType.versionType)
    })
  }),
...
var HistoryViewerToolbar = function (_Component) {
  ...
  _createClass(HistoryViewerToolbar, [{
    ...
    value: function handleRevert() {
      ...
      return revertToVersion(recordId, versionId, 'DRAFT', 'DRAFT').then(function () {
    ...
    value: function render() {
      ...
      var isReverting = this.state.isReverting;


      var revertButtonTitle = '';
      if (isReverting) {
        revertButtonTitle = _i18n2.default._t('HistoryViewerToolbar.REVERT_IN_PROGRESS', 'Revert in progress...');
      } else if (isLatestVersion) {
        revertButtonTitle = _i18n2.default._t('HistoryViewerToolbar.REVERT_UNAVAILABLE', 'Unavailable for the current version');
      }
...
var HistoryViewerVersionDetail = function (_PureComponent) {
  ...
  _createClass(HistoryViewerVersionDetail, [{
    ...
    value: function renderPreview() {
      var _props2 = this.props,
          _props2$version = _props2.version,
          AbsoluteLink = _props2$version.AbsoluteLink,
          LastEdited = _props2$version.LastEdited,
          Version = _props2$version.Version,
  ...
  _createClass(HistoryViewerVersionState, [{
    ...
    value: function getPublishedState() {
      ...
      if (version.Version === 1) {
        return _i18n2.default._t('HistoryViewer.Created', 'Created');
      }

      if (version.Published) {
        if (version.Deleted) {
          if (version.Draft) {
            return _i18n2.default._t('HistoryViewer.Archived', 'Archived');
          }
...
/***/ "./client/src/legacy/VersionedEditForm/VersionedEditForm.js":
/***/ (function(module, exports, __webpack_require__) {
...
_jquery2.default.entwine('ss', function ($) {
  $('.cms-edit-form .btn-toolbar #Form_ItemEditForm_action_doUnpublish').entwine({
    onclick: function onclick(e) {
      var message = _i18n2.default._t('VersionedEditForm.PUBLISH_CONFIRM_MESSAGE', 'Are you sure you want to remove your record from the published site?\n\nThis record will still be available in the CMS as draft.');
  ...
  $('.cms-edit-form .btn-toolbar #Form_ItemEditForm_action_doArchive').entwine({
    onclick: function onclick(e) {
      var message = _i18n2.default._t('VersionedEditForm.ARCHIVE_CONFIRM_MESSAGE', 'Warning: This record will be unpublished before being sent to the archive.\n\nAre you sure you want to proceed?');
...
var versionType = _propTypes2.default.shape({
  ...
  Draft: _propTypes2.default.boolean,
  Deleted: _propTypes2.default.boolean,
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["HistoryViewer"] = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"presets\":[[\"env\",{\"modules\":false}],\"react\"],\"plugins\":[\"transform-object-rest-spread\"],\"comments\":false,\"cacheDirectory\":true}!./client/src/components/HistoryViewer/HistoryViewer.js");
